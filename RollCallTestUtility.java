...
public class RollCallTestUtility{
    ...
    public static Campaign createEventCampaign() {
        ...
        insert c2;
        Lead le = new Lead(firstName='Lead', lastName='Lee', company='SF');
        insert le;
        CampaignMember m1 = new CampaignMember(LeadId=le.ID, campaignId=c.ID);
        insert m1;
        Lead le2 = new Lead(firstName='Lead2', lastName='Lee', company='SF');
        insert le2;
        ...
        insert m3;
        Contact cn2 = new Contact(firstName='Contact2', lastName='C');
        insert cn2;
